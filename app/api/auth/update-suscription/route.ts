...
export async function POST(request: Request) {
    ...
    cookieStore.set("suscripcionBasica", String(updatedUserData.suscripcionBasica), {
        httpOnly: true,
        path: "/",
    });
    cookieStore.set("suscripcionPremiun", String(updatedUserData.suscripcionPremiun), {
        httpOnly: true,
        path: "/",
    });
