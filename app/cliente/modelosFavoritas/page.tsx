...
export default function ModelosFavoritasClient() {
    ...
    const [userData, setUserData] = useState<{ token: string | null; userId: string | null }>({
        token: null,
        userId: null,
    });
    ...
    if (favoritos.length === 0) return <p className="text-center">No tienes modelos favoritos</p>;

    return (
        <div className="flex flex-col justify-center items-center bg-white">
            <h1 className="text-2xl font-bold text-center p-5 bg-segundary w-full text-white">Mis Modelos Favoritas</h1>
